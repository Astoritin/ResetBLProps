...
**该模块包含了源自 [Shamiko](https://github.com/LSPosed/LSPosed.github.io) 的 Bootloader 属性值重置脚本。**   
   
**非常感谢 [LSPosed Developers](https://github.com/LSPosed) 的工作！**
...
- [Shamiko](https://github.com/LSPosed/LSPosed.github.io) - the implementation of bootloader properties reset
